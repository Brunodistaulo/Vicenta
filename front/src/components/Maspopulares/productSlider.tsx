...
export default function ProductSlider() {
    ...
    return (
        <div className="w-full mt-10 md:mt-14 lg:mt-20 max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between items-center mb-4">
                <h2 className="text-2xl font-medium text-hero-home">Más populares</h2>
